      ...
      <div className="max-w-2xl mx-auto">
        <AnimatedReveal animation="fade-up" delay={100}>
          <div className="relative border border-hud-amber/30 p-6 mb-8">
            ...
            {/* Contact entries without nested AnimatedReveal */}
            <div className="space-y-3">
              {contacts.map((contact, index) => (
                <div
                  key={contact.type}
                  className="flex items-center justify-between p-3 border border-border/50 hover:border-hud-amber/30 transition-colors group"
                  style={{
        ...
        <AnimatedReveal delay={300} animation="fade-up">
