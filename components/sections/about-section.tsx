        ...
        <AnimatedReveal animation="fade-up" delay={100}>
          <div className="relative border border-border/50 p-6">
            ...
            <div className="space-y-4 hud-body text-muted-foreground">
              <p>
                I build production AI systems that deliver measurable outcomes—not prototypes, not demos, but real tools
                ...
                <div key={cap.category}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {cap.items.map((item) => (
                      <span
                        key={item}
                        className="hud-micro px-2 py-1 border border-hud-amber/30 text-hud-amber hover:bg-hud-amber/10 transition-colors"
                      >
                        {item}
                      </span>
                    ))}
