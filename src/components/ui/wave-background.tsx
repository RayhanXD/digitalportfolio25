...
export function Waves({
    ...
    useEffect(() => {
        ...
        // Event handlers and tick are intentionally omitted: they are recreated each render but
        // this effect should only re-subscribe when strokeColor changes (affects line paths).
        // eslint-disable-next-line react-hooks/exhaustive-deps -- mount + strokeColor
    }, [strokeColor])
